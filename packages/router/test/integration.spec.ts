...
import {ActivatedRoute, ActivatedRouteSnapshot, CanActivate, CanActivateChild, CanLoad, CanDeactivate, DetachedRouteHandle, Event, GuardsCheckEnd, GuardsCheckStart, NavigationCancel, NavigationEnd, NavigationError, NavigationStart, PRIMARY_OUTLET, ParamMap, Params, PreloadAllModules, PreloadingStrategy, Resolve, ResolveEnd, ResolveStart, RouteConfigLoadEnd, RouteConfigLoadStart, RouteReuseStrategy, Router, RouterModule, RouterPreloader, RouterStateSnapshot, RoutesRecognized, RunGuardsAndResolvers, UrlHandlingStrategy, UrlSegmentGroup, UrlTree} from '@angular/router';
    ...
    beforeEach(() => {
      ...
      class AccessibleComponent {
        constructor(private route: ActivatedRoute) {
          //console.log("ACCESSIBLE COMPONENT");
      ...
      TestBed.configureTestingModule({
        declarations: [AccessibleComponent, DefaultComponent],
        imports: [
