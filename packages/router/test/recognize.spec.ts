  ...
  it('should match routes in the depth first order', () => {
    ...
    checkRecognize(
        ...
        'a/paramA', (s: RouterStateSnapshot) => {
          //to support cascading routes (when route guard=>false) recognize( ) observable sends back all matches
          //but obeys the depth-first-order which is still verified for the first result in this test.
